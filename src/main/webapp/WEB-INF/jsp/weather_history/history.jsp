	...
	<div class="contents d-flex">
		...
		<nav class="col-2">
			<div class="logo d-flex justify-content-center mt-3">
				...
				<span class="text-white front-weight-bold ml-2">기상청</span>
			</div>
			<%--메뉴 --%>
			<%--felx-column(세로메뉴) --%>
			<ul class="nav flex-column mt-4">
				<li class="nav-item">
					<a href="/weather/history-view" class="nav-link menu-front">날씨</a>
				</li>
				<li class="nav-item">
					<a href="/weather/history-view" class="nav-link menu-front">날씨 입력</a>
				</li>
				<li class="nav-item">
					<a href="/weather/history-view" class="nav-link menu-front">테마날씨</a>
				</li>
				<li class="nav-item">
					<a href="/weather/history-view" class="nav-link menu-front">관측기후</a>
				</li>
			</ul>
		</nav>
		<%--날씨 히스토리 --%>
						...
						<td>
							<c:choose>
								<c:when test="${weather.weather == '맑음'}">
									<img src="/img/WeatherHistory/sunny.jpg" alt="맑음">
								</c:when>
								<c:when test="${weather.weather == '구름조금'}">
									<img src="/img/WeatherHistory/partlyCloudy.jpg" alt="구름조금">
								</c:when>
								<c:when test="${weather.weather == '흐림'}">
									<img src="/img/WeatherHistory/cloudy.jpg" alt="흐림">
								</c:when>
								<c:when test="${weather.weather == '비'}">
									<img src="/img/WeatherHistory/rainy.jpg" alt="비">
								</c:when>
								<c:otherwise>
									${weather.weather}
								</c:otherwise>
		...
		<footer class="d-flex align-items=center">
			<div class="footer-logo mt-4">
				<img class="foot-logo-image"
					src="https://www.weather.go.kr/w/resources/image/foot_logo.png" width="120">
			</div>
